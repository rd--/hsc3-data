...
-- | Hash 145-element parameter sequence to a 32-bit word using the Murmur hash algorithm.
dx7_param_hash :: Dx7_Param -> Dx7_Hash
dx7_param_hash = Hash.asWord32 . Hash.hash32 . ByteString.pack . map fromIntegral
